...
# Considered refactoring lunch_menu and dinner_menu into one view,
# but this would actually result in more code so was scrapped.
def lunch_menu(request):
    ...
    **Template**
    ...
    return render(request, "menu/menu_lunch.html", {"lunch_menu": menu_items})
...
def dinner_menu(request):
    ...
    **Template**
    ...
    return render(request,
                  "menu/menu_dinner.html", {"dinner_menu": menu_items})
...
def add_menu_item(request):
    ...
    **Template**
    ...
    if request.method == "POST":
        ...
        if menu_form.is_valid():
            ...
            messages.add_message(
                request,
                messages.SUCCESS,
                "You have successfully added a menu item",
            )
            # Checks if meal_category selected is lunch or dinner and redirects
    ...
    return render(request, "menu/menu_form.html", {"menu_form": menu_form})


@staff_member_required
def edit_menu_item(request, slug):
    """
    Displays a form for admins to edit an existing
    instance of :model:`menu.Menu`.
    ...
    if request.method == "POST":
        ...
        if menu_form.is_valid():
            ...
            messages.add_message(
                request,
                messages.SUCCESS,
                "You have successfully edited the menu item",
            )
            # Checks if meal_category selected is lunch or dinner and redirects
            if meal_category == "lunch":
                return redirect("lunch_menu")
