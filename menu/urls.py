...
urlpatterns = [
    ...
    path('menu/lunch_menu/delete_booking/<int:id>', views.delete_menu_item, name='menu_delete'),
    ...
    path('menu/dinner_menu/delete_booking/<int:id>', views.delete_menu_item, name='menu_delete'),
